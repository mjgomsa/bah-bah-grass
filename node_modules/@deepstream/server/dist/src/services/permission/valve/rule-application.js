...
const record_request_1 = require("../../../handlers/record/record-request");
...
class RuleApplication {
    ...
    onRuleError(error) {
        ...
        const errorMsg = `error when executing ${this.params.rule.fn.toString()}${os_1.EOL}for ${this.params.name}: ${error.toString()}`;
        this.params.logger.warn(constants_1.EVENT_ACTION[constants_1.EVENT_ACTION.MESSAGE_PERMISSION_ERROR], errorMsg, { recordName: this.params.name });
        this.params.callback(this.params.socketWrapper, this.params.message, this.params.passItOn, constants_1.EVENT_ACTION.MESSAGE_PERMISSION_ERROR, false);
        this.destroy();
    }
    /**
    ...
    onLoadError(event, errorMessage, recordName, socket) {
        ...
        this.params.logger.error(constants_1.RECORD_ACTION[constants_1.RECORD_ACTION.RECORD_LOAD_ERROR], errorMsg, { recordName, socketWrapper: socket });
        this.params.callback(this.params.socketWrapper, this.params.message, this.params.passItOn, constants_1.RECORD_ACTION.RECORD_LOAD_ERROR, false);
        this.destroy();
    }
    /**
    ...
    getCurrentData() {
        ...
        if ((msg.topic === constants_1.TOPIC.RPC) ||
            ...
            (msg.topic === constants_1.TOPIC.RECORD && msg.action === constants_1.RECORD_ACTION.UPDATE)) {
        ...
        else if (msg.topic === constants_1.TOPIC.RECORD && msg.action === constants_1.RECORD_ACTION.PATCH) {
    ...
    getRecordPatchData(msg) {
        ...
        if (!msg.path) {
            this.params.logger.error(types_1.EVENT.ERROR, `Missing path for record patch ${msg.name}`, { message: msg });
            return;
        }
        ...
        if (typeof currentData !== UNDEFINED && currentData !== LOADING) {
            ...
            json_path_1.setValue(data, msg.path, msg.parsedData);
            return data;
        }
