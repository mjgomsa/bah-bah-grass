...
const LogLevelValidation = {
    type: ['string', 'integer'],
    enum: [
        'DEBUG', types_1.LOG_LEVEL.DEBUG,
        'INFO', types_1.LOG_LEVEL.INFO,
        'WARN', types_1.LOG_LEVEL.WARN,
        'ERROR', types_1.LOG_LEVEL.ERROR,
        'OFF', types_1.LOG_LEVEL.OFF
    ]
};
function getPluginOptions(name, types, properties) {
    return {
        [name]: {
            type: 'object',
            properties: {
...
const httpServer = getPluginOptions('httpServer', ['default', 'uws'], {
    host: { type: 'string', minLength: 1 },
    port: { type: 'integer', minimum: 1 },
    allowAllOrigins: { type: 'boolean' },
    origins: { type: 'array', items: { type: 'string', format: 'uri' } },
});
const cacheOptions = getPluginOptions('cache', ['default'], {});
const storageOptions = getPluginOptions('storage', ['default'], {});
const telemetryOptions = getPluginOptions('telemetry', ['deepstreamIO'], {
...
const permissionOptions = getPluginOptions('permission', ['config', 'none'], {
    path: { type: 'string', minLength: 1 },
...
const loggerOptions = getPluginOptions('logger', ['default', 'json'], {
    colors: { type: 'boolean' },
    logLevel: LogLevelValidation,
    options: { type: 'object' }
});
const subscriptionsOptions = getPluginOptions('subscriptions', ['default'], {
    subscriptionsSanityTimer: { type: 'integer', minimum: 50 },
});
const monitoringOptions = getPluginOptions('monitoring', ['http', 'log', 'none'], {});
const locksOptions = getPluginOptions('locks', ['default'], {
    holdTimeout: { type: 'integer', minimum: 50 },
    requestTimeout: { type: 'integer', minimum: 50 },
});
const clusterNodeOptions = getPluginOptions('clusterNode', ['default'], {});
const clusterRegistryOptions = getPluginOptions('clusterRegistry', ['default'], {
...
const clusterStatesOptions = getPluginOptions('clusterStates', ['default'], {
