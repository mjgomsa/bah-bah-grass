...
exports.WSBinaryConnectionEndpoint = void 0;
...
class WSBinaryConnectionEndpoint extends connection_endpoint_1.default {
    constructor(wsOptions, services, config) {
        super(wsOptions, services, config);
        this.wsOptions = wsOptions;
        this.description = 'Binary WebSocket Connection Endpoint';
    }
    async init() {
        super.init();
...
exports.WSBinaryConnectionEndpoint = WSBinaryConnectionEndpoint;
